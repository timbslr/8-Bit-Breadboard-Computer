...
#ruledef {
	...
	ldox {reg: register}, {addr: u16}              => 0b01011 @ reg @ le(addr)
	ldoy {reg: register}, {addr: u16}              => 0b00111 @ reg @ le(addr)
	ldsprel {imm: i8}                              => 0b01010 @ imm
	st {reg: register}, {addr: u16}                => 0b00011 @ reg @ le(addr)
	stox {reg: register}, {addr: u16}              => 0b01001 @ reg @ le(addr)
	stoy {reg: register}, {addr: u16}              => 0b00101 @ reg @ le(addr)
	stosprel {reg: register}, {addr: u16}          => 0b01000 @ reg @ le(addr)
	...
	out7sd {reg: register}                         => 0b00110 @ reg
	s7sdsm                                         => 0b11000010
	s7sdum                                         => 0b00000011
	out7sdi {imm: i8}                              => 0b00110111 @ imm
