...
<br>
<part-list src="{{ site.baseurl }}/resources/PartLists/BUF-Register.csv"></part-list>

### Schematic

<br>
<img src="{{ site.baseurl }}/resources/Wiring Diagrams/Buffer-Register.svg" alt="Buffer-Register schematic" style="width:100%; height:auto;">
