...
<br>
<part-list src="{{ site.baseurl }}/resources/PartLists/TMP-Register.csv"></part-list>
<br>

### Schematic

<img src="{{ site.baseurl }}/resources/Wiring Diagrams/TMP-Register.svg" alt="TMP-Register schematic" style="width:100%; height:auto;">
